		...
		const struct som_exec_auxhdr *hpuxhdr)
{
	...
	retval = do_mmap_locked(file, code_start, code_size, prot,
	...
	retval = do_mmap_locked(file, data_start, data_size,
	...
	retval = do_mmap_locked(NULL, bss_start, som_brk - bss_start,
